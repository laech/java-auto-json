...
public final class AutoJson_ObjectAddress extends autojson.bind.NullableMapper<ObjectAddress> {
    ...
    private static final autojson.bind.Mapper<java.lang.String> precisionMapper = new autojson.internal.bind.java.lang.StringMapper();
    private static final autojson.bind.Mapper<java.math.BigDecimal> latitudeMapper = new autojson.internal.bind.java.math.BigDecimalMapper();
    private static final autojson.bind.Mapper<java.math.BigDecimal> longitudeMapper = new autojson.internal.bind.java.math.BigDecimalMapper();
    private static final autojson.bind.Mapper<java.lang.String> addressMapper = new autojson.internal.bind.java.lang.StringMapper();
    private static final autojson.bind.Mapper<java.lang.String> cityMapper = new autojson.internal.bind.java.lang.StringMapper();
    private static final autojson.bind.Mapper<java.lang.String> stateMapper = new autojson.internal.bind.java.lang.StringMapper();
    private static final autojson.bind.Mapper<java.lang.String> zipMapper = new autojson.internal.bind.java.lang.StringMapper();
    private static final autojson.bind.Mapper<java.lang.String> countryMapper = new autojson.internal.bind.java.lang.StringMapper();
