...
public final class AutoJson_ObjectListSetObject extends autojson.bind.NullableMapper<ObjectListSetObject> {
    ...
    private static final autojson.bind.Mapper<java.util.List<java.util.Set<autojson.integration.ObjectInt>>> valuesMapper = new autojson.internal.bind.java.util.ListMapper<>(new autojson.internal.bind.java.util.SetMapper<>(new AutoJson_ObjectInt()));
