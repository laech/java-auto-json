...
public final class AutoJson_ObjectListObject extends autojson.bind.NullableMapper<ObjectListObject> {
    ...
    private static final autojson.bind.Mapper<java.util.List<autojson.integration.ObjectString>> valuesMapper = new autojson.internal.bind.java.util.ListMapper<>(new AutoJson_ObjectString());
