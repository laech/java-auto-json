...
public final class AutoJson_ObjectSetObject extends autojson.bind.NullableMapper<ObjectSetObject> {
    ...
    private static final autojson.bind.Mapper<java.util.Set<autojson.integration.ObjectInt>> valuesMapper = new autojson.internal.bind.java.util.SetMapper<>(new AutoJson_ObjectInt());
